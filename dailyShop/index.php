        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <?php foreach($ctg as $key=>$value):?>
                    <li ><a href="#<?php echo $value['name'];?>" data-toggle="tab"><?php echo $value['name'];?></a></li>
                   <?php endforeach; ?>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                     ...
                     <?php   foreach($products as $key=>$value):
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img max-height="60px" max-width="60px"  src="../uploads/<?php echo  $value['image'];?>" alt="polo shirt img"></a>
                           
                            <a class="aa-add-card-btn" href="#<?php echo 
                            $value['name'];?>"><?php echo 
                            $value['name'];?><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="#"></a></h4>
                              <span class="aa-product-price"><?php echo 
                            $value['price'];?></span><span class="aa-product-price"><del><?php echo 
                            $value['price'];?></del></span>
                            </figcaption>
                          </figure>                        
                    ...
                    <!-- / men product category ended -->
                    <!-- start women product category start -->
                    <div class="tab-pane fade" id="women">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="../uploads/<?php echo $value['image']; ?>" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn" href="#"><?php echo $value['name']; ?><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                              <span class="aa-product-price"><?php echo $value['price']; ?></span><span class="aa-product-price"><del><?php echo $value['price']; ?></del></span>
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
